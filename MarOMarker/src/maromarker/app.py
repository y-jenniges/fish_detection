...
from maromarker.ui import page_home as PageHome
from maromarker.ui import page_settings as PageSettings
from maromarker.ui import page_about as PageAbout
from maromarker.ui import page_data as PageData
#from maromarker.ui import page_handbook as PageHandbook
from maromarker.ui.table_window import TableWindow
from maromarker.ui.welcome_window import WelcomeWindow
"""
...
class MarOMarker_MainWindow(QtWidgets.QMainWindow):
    ...
    def autosave(self):
        ...
        """
        # flush the log periodically so it survives a force-kill
        try:
            sys.stdout.flush()
            sys.stderr.flush()
        except Exception:
...
from maromarker import ressources_rc
    ...
    def write(self, text):
        if self._stream is not None:
            try:
                ...
                pass
        try:
            # do not flush per write: it is slow in the hot paths. faulthandler
            # flushes its own traceback on a crash, and autosave flushes the log
