...
out_heatmaps = layers.Conv2D (11, 1, padding='same', activation="softmax", name = "heatmap")(x)
out_segmentation = layers.Conv2D (1, 1, padding='same', activation="sigmoid", name = "segmentation")(x)
